      ...
      <div className="relative z-10 w-full max-w-md space-y-8 rounded-3xl border border-zinc-200/80 bg-white/80 p-8 shadow-2xl backdrop-blur-xl dark:border-zinc-800/80 dark:bg-zinc-900/80 transition-all">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-zinc-500 font-mono">
            Access your documents, summaries, and notes
          </p>

          {success && (
            <div className="mt-3 flex items-center justify-center gap-1.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 p-2 text-xs font-mono text-emerald-600 dark:text-[#d4ff3a]">
        ...
        <form className="mt-6 space-y-5" onSubmit={handleLogin}>
          ...
          <div className="text-center pt-2">
            ...
            >
              Don&apos;t have an account? <span className="underline font-semibold">Create Account</span>
            </Link>
          </div>
        </form>
      </div>
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-[#fbfbf9] dark:bg-[#09090c]">
